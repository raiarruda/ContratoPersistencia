...
const string connectionUri = "mongodb+srv://raissa:WILEurPPDnrDWEJF@cluster0.lxkzp.mongodb.net/?retryWrites=true&w=majority";
var persistencia = new Persistencia(new PersistenciaMongoDB(connectionUri,"cliente_persistencia", "clientes"));
